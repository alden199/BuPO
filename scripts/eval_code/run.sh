...
#!/bin/bash
source /opt/anaconda3/etc/profile.d/conda.sh   # set to your path
MODEL_NAME=Qwen3-14B
export VLLM_WORKER_MULTIPROC_METHOD=spawn
MODEL_CKPT=/netcache/huggingface/models/${MODEL_NAME}
# MODEL_NAME=$(basename "$MODEL_CKPT")
OUTPUT_DIR="/ssd/tanyuqiao/Entropy_Grad/output_gen/$MODEL_NAME/humaneval" # output dir
mkdir -p $OUTPUT_DIR

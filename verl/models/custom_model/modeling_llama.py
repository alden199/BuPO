...
@dataclass
class BaseModelOutputWithPastNew(ModelOutput):
    """
    ...
    mlp: Optional[tuple[torch.FloatTensor, ...]] = None
...
class CausalLMOutputWithPastNew(ModelOutput):
    ...
    hidden_states: Optional[tuple[torch.FloatTensor, ...]] = None
    attentions: Optional[tuple[torch.FloatTensor, ...]] = None
    mid_layer_logits: Optional[UserDict[int, torch.FloatTensor]] = None
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return BaseModelOutputWithPastNew(
...
class LlamaForCausalLM(LlamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```"""
        outputs: BaseModelOutputWithPastNew = self.model(
            input_ids=input_ids,
            attention_mask=attention_mask,
            position_ids=position_ids,
            past_key_values=past_key_values,
        ...
        args:
            startk: which layer used as internal layer policy. For Qwen3-4b, stark \in [0, 35]. 
